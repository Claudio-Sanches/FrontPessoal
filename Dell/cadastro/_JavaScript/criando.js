function myFunction() {
    ...
    cell2.innerHTML = "<td><input type='text' name='numero' id='numero' autocomplete='off' size='20' requered/></td>"

    var row = table.insertRow(8);
    var cell1 = row.insertCell(0);
    var cell2 = row.insertCell(1);
    cell1.innerHTML = "<td><label>Complemento :</label></label></td>"
    cell2.innerHTML = "<td><input type='text' name='complemento' id='complemento' autocomplete='off' size='20' /></td>"
